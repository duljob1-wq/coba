      ...
      <main className="flex-1 max-w-7xl mx-auto w-full p-4 md:p-8">
        ...
        {activeTab === 'variables' && (
            <div className="animate-in fade-in duration-300 max-w-5xl mx-auto">
                 ...
                 {/* ... Variable UI (Copy existing code) ... */}
                 {/* Placeholder for brevity: The full implementation from previous versions is preserved in logic */}
        ...
        {/* REVISED REPORTS TAB (New Print UI & Filtering) */}
        {activeTab === 'reports' && (
